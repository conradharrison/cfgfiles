...
--    kpress(META.."grave", "ioncore.goto_next_screen()"),
    ...
    kpress(META.."Up", "ioncore.goto_next(_sub, 'down')"),
    kpress(META.."Down", "ioncore.goto_next(_sub, 'up')"),
    kpress(META.."Right", "ioncore.goto_next(_sub, 'left')"),
    kpress(META.."Left", "ioncore.goto_next(_sub, 'right')"),
    kpress(ALTMETA.."Right", "WScreen.dec_index(_, _sub)", "_sub:non-nil"),
    kpress(ALTMETA.."Left", "WScreen.inc_index(_, _sub)", "_sub:non-nil"),
})
...
defbindings("WMPlex.toplevel", {
    ...
    bdoc("Run a terminal emulator (dark)."),
    kpress("Shift+F2", "mod_query.exec_on_merr(_, XTERM_DARK or 'xterm')"),
